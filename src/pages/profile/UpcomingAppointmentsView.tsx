...
const DepartmentIcon = ({ department }: { department: string }) => {
  // Map department names to icon types
  const getIconColor = () => {
    if (department.toLowerCase().includes('cardio')) return '#00ABDA';
    if (department.toLowerCase().includes('neuro')) return '#00ABDA';
    if (department.toLowerCase().includes('onco')) return '#00ABDA';
    return '#00ABDA';
  };
