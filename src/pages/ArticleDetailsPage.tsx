...
const ArticleDetailsPage: React.FC = () => {
  ...
  const title      = articlesService.getField(article.title);
  const blockquote = articlesService.getField(article.blockquote);
  const body       = articlesService.getField(article.body);

  const publishedDate = article.published_at
    ? new Date(article.published_at).toLocaleDateString('en-GB', { day: '2-digit', month: 'long', year: 'numeric' })
    : '';
          ...
          <div className="article-detail-card">
              ...
              <div className="article-detail-hero-content">
                ...
                <div className="article-detail-meta">
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span className="article-detail-meta-text">{article.author}</span>
                  </div>
                  {publishedDate && <>
                  ...
                  {article.read_time && <>
                    <span className="article-detail-meta-bullet">•</span>
                    <span className="article-detail-meta-text">{article.read_time}</span>
                  </>}
                </div>
              </div>
            </div>
            ...
            <div className="article-detail-body">
              ...
              <div className="article-detail-share">
                <h3 className="article-detail-share-heading">Share Article</h3>
