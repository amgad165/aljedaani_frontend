...
const MobileNavbar = () => {
  ...
  const navItems = [
    ...
    { label: t('patientEducation'), href: '/patient-education' },
    ...
    <header data-nosnippet="true" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Profile Icon - Show only when authenticated */}
            ...
            >
              <button
                style={{
                  ...
                  background: user.profile_photo ? `url(${user.profile_photo}) center/cover no-repeat` : '#14C8F9',
                  cursor: 'pointer',
                  padding: 0,
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 2px 8px rgba(1, 85, 203, 0.3)';
                }}
                onMouseLeave={(e) => {
